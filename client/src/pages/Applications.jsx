      ...
      <div className='flex gap-2 mb-6 mt-3'>
        {
          ...
          <>
            ...
            <button onClick={e =>setIsEdit(false)} className='bg-green-100 border border-e-gray-400 px-4 py-2 rounded-lg'>Save</button>
          </>
          : <div className='flex gap-2'>
              <a className='bg-blue-100 text-blue-600 px-4 py-2 rounded-lg' href="">
                Resume
              </a>
              <button onClick={()=>setIsEdit(true)} className='text-gray-500 border border-y-gray-300 rounded-lg px-4 py-2'>
                Edit
              </button>
            </div>
        }
